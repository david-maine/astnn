import pandas as pd
import os
from transforms import rename_vars, add_dead_code
...
class Pipeline:
    def __init__(self,  ratio, root):
        ...
        self.test_file_path = self.root+'test/test_.pkl'
        self.size = 128
    ...
    def generate_block_seqs(self,data_path,part):
        ...
        trees['code'].apply(rename_vars)
        trees['code'].apply(add_dead_code)
